                  ...
                  <div class="col-md-6" id="accordion">
                    ...
                    <div class="card card-widget">
                      ...
                      <div class="widget-user-header bg-secondary">
                        ...
                        <a href="{{route('mySaving.delete', $mySaving->id)}}" id="delete" type="submit" class="btn btn-sm float-right"><i class="fa fa-trash text-danger"></i></a>
                          @if($mySaving->status == 'In Progress')
                          <button type="submit" data-toggle="modal" data-target="#modal-edit-saving{{$mySaving->id}}"
                            class="btn btn-sm float-right"><i class="fa fa-edit text-info"></i></button>
                            <a href="{{route('mySaving.terminate', $mySaving->id)}}" id="terminate" type="submit" class="btn btn-sm float-right"><i class="fa fa-dismiss text-warning">X</i></a>
                            <a href="{{route('mySaving.complete', $mySaving->id)}}" id="complete" type="submit" class="btn btn-sm float-right"><i class="fa fa-check text-success"></i></a>
                          @endif
                        </div>
                        <!-- /.widget-user-image -->
                        <br>
                      ...
                      <div class="card-footer p-0">
                        <ul class="nav flex-column">
                          <li class="nav-item text-center">
                            <a href="#" class="nav-link text-white text-bold">
